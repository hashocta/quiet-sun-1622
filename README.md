...
```
npm create cloudflare@latest -- --template=cloudflare/templates/quiet-sun-1622
```

A live public deployment of this template is available at [https://quiet-sun-1622.templates.workers.dev](https://quiet-sun-1622.templates.workers.dev)
